				        ...
				        <div class="container">            
				            ...
				            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
				                <ul class="nav navbar-nav navbar-center" data-in="fadeInDown" data-out="fadeOutUp">
				                    <li class="text-center acitve"><a href="<?php echo URLROOT; ?>/index">Home</a></li>
				                    <li class="text-center"><a href="<?php echo URLROOT; ?>/Shop">Shop</a></li>
				                    <li class="text-center"><a href="<?php echo URLROOT; ?>/Features">Features</a></li>
				                    <li class="text-center"><a href="<?php echo URLROOT; ?>/Blog">Blog</a></li>
				                    <li class="text-center"><a href="<?php echo URLROOT; ?>/contact">Contact</a></li>
				                </ul><!--/.nav -->
				            </div><!-- /.navbar-collapse -->
				        </div><!--/.container-->
				    </nav><!--/nav-->
								...
								<div class="single-inner-populer-products">
									<div class="row">
										<div class="col-md-4 col-sm-12">
											<div class="single-inner-populer-product-img" id="miss">
